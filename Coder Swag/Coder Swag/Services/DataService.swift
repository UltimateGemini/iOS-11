...
class DataService {
    ...
    private let hats = [
        ...
        Product(title: "Devslopes Logo Hat Snapback", price: "$18", imageName: "hat04.png")
    
    ]
    
    private let hoodies = [
        
        Product(title: "Devslopes Logo Logo Grey", price: "$30", imageName: "hoodie01.png"),
        Product(title: "Devslopes Logo Logo Red", price: "$30", imageName: "hoodie02.png"),
        Product(title: "Devslopes Logo Hoodie Grey", price: "$30", imageName: "hoodie03.png"),
